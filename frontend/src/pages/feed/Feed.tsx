...
import { Heart, Star, ShieldAlert, MessageCircle, RefreshCcw, Quote, Sparkles } from 'lucide-react';
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-[9px] text-gray-400 font-black uppercase tracking-widest mt-0.5 inline-flex items-center gap-2">
                            <span className="w-1 h-1 bg-gray-300 rounded-full" /> {item.itemType} • {new Date(item.sharedAt).toLocaleTimeString('vi-VN', { hour: '2-digit', minute: '2-digit' })}
                        </p>
                    </div>
                </div>
